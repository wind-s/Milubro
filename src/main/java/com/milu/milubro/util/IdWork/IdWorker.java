package com.milu.milubro.util.IdWork;
 ...
 *
 * 这里的的开始时间截，一般是我们的id生成器开始使用的时间，由我们程序来指定的（如下下面程序IdWorker类的startTime属性）。39位的时间截，可以使用17年，年T = (1L << 39) / (1000L * 60 * 60 * 24 * 365) = 17
